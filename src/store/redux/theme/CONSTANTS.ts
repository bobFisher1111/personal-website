...
const createMarkdownStyles = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    lists: {
      ul: {
        sx: { pl: 4, mb: 2, listStyleType: 'disc', color: colors.primary, lineHeight: 1.6 },
      },
      ol: {
        sx: { pl: 4, mb: 2, listStyleType: 'decimal', color: colors.primary, lineHeight: 1.6 },
      },
      li: {
    ...
    table: {
      ...
      th: {
        sx: { textAlign: 'left', p: 1, fontWeight: 'bold', color: colors.primary },
      },
      td: {
